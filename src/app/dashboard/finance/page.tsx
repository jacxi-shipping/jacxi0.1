      ...
      <DashboardSurface>
          ...
          <DashboardGrid className="grid-cols-1 md:grid-cols-2">
            <Box
              sx={{
                ...
                bgcolor: 'var(--success-bg, rgba(74, 222, 128, 0.08))',
                display: 'flex',
                alignItems: 'center',
                gap: 2,
              }}
            ...
            <Box
              sx={{
                ...
                bgcolor: 'var(--warning-bg, rgba(251, 191, 36, 0.08))',
                display: 'flex',
                alignItems: 'center',
                gap: 2,
              }}
        ...
        {isAdmin && summary && summary.userBalances.length > 0 && (
          <DashboardPanel title="User Balances" description="Users with outstanding balances">
            <Table
              data={summary.userBalances.slice(0, 10)}
              keyField="userId"
              columns={[
                {
                  header: 'User',
                  ...
                  render: (user) => (
                    <Typography 
                      sx={{ 
                        fontSize: '0.85rem', 
                        fontWeight: 600, 
                        color: user.currentBalance >= 0 ? 'var(--text-primary)' : 'rgb(248, 113, 113)' 
                      }}
                    >
